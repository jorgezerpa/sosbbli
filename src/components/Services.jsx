...
export const Services = () => {
   ...
   return (
    <>
    <div ref={ref} className={`${inView && 'animate-fadeIn'} opacity-0 mx-auto max-w-screen-md text-center mb-8 lg:mb-12 mt-20`}>
    ...
    <div className='w-full relative flex justify-evenly flex-wrap'>
        {services.map((service, i)=>(
                <div key={'services'+service.title+i} className={`${inView && 'animate-fadeIn'} opacity-0 w-[250px] rounded overflow-hidden shadow-lg`}>
