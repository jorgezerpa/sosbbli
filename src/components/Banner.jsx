    ...
    <>
      <div className='relative min-h-screen w-full'>
          ...
          <div className='px-2 absolute w-full h-full flex flex-col justify-center items-center'>
              <Image alt="" className='animate-zoomIn opacity-0' src='/logo-col.png' width={350} height={350} />
      ...
      <div ref={ref} className='relative w-full h-[200px] sm:h-[250px] md:h-[300px]'>
          {/* bg image  */}
        ...
        <div>
          ...
          <div className={`${ inView && 'animate-[zoomIn_.5s_ease_forwards_.0s]' } opacity-0 absolute hidden md:block top-0 right-[150px] w-[150px] h-[150px] bg-orange-500`}></div>
          <div className={`${ inView && 'animate-[zoomIn_.5s_ease_forwards_.2s]' } opacity-0 absolute hidden md:block top-[150px] right-[300px] w-[150px] h-[150px] bg-orange-500`}></div>
          <div className={`${ inView && 'animate-[zoomIn_.5s_ease_forwards_.0s]' } opacity-0 absolute hidden sm:block md:hidden top-0 right-[125px] w-[125px] h-[125px] bg-orange-500`}></div>
          <div className={`${ inView && 'animate-[zoomIn_.5s_ease_forwards_.2s]' } opacity-0 absolute hidden sm:block md:hidden top-[125px] right-[250px] w-[125px] h-[125px] bg-orange-500`}></div>
          <div className={`${ inView && 'animate-[zoomIn_.5s_ease_forwards_.0s]' } opacity-0 absolute block sm:hidden top-0 right-[100px] w-[100px] h-[100px] bg-orange-500`}></div>
          <div className={`${ inView && 'animate-[zoomIn_.5s_ease_forwards_.2s]' } opacity-0 absolute block sm:hidden top-[100px] right-[200px] w-[100px] h-[100px] bg-orange-500`}></div>
        </div>
          {/* small top-over image  */}
        <div className='block sm:hidden absolute w-full h-full top-0 left-0 z-30 bg-center bg-no-repeat bg-cover' style={{ backgroundImage: `url(/ls6.jpg)` }}></div>
          {/* content  */}
